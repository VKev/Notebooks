...
## Key points
- Unity `6.4 (6000.4)`: `#pragma vertex` và `#pragma fragment` là bắt buộc trong regular graphics shader để chỉ định function cho vertex shader và fragment shader.
...
- Nhiều dòng variant nhân với nhau, nên variant count tăng nhanh.
...
- Không thêm keyword cho mọi option nhỏ vì variant count sẽ phình nhanh.
