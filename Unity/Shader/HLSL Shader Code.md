...
## Key points
- Unity `6.4 (6000.4)`: Unity dùng `HLSL` để viết shader program.
...
- Không đổi `CGPROGRAM` sang `HLSLPROGRAM` máy móc trong shader cũ, vì `CGPROGRAM` tự include Built-in helper.
