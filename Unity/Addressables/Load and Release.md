...
- Nếu instantiate bằng `Object.Instantiate` thông thường sau khi load, Unity không track instance đó, phải release handle gốc thủ công và tự `Destroy` instance.
...
public class AssetLoader : MonoBehaviour
{
    ...
    // Cách 1: Load rồi Instantiate thủ công
    ...
    // Cách 2: InstantiateAsync cho Addressables track
    ...
    void OnDestroy()
    {
        // Destroy instance trước, release handle sau
        if (_instance != null)
            Destroy(_instance);
