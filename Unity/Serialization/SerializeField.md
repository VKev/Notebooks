...
## Key points
- Theo Unity `6.4 (6000.4)`, Unity serialize public field theo mặc định, còn private field cần thêm `[SerializeField]`.
...
## Decision rules
- dùng cho config của `MonoBehaviour` và `ScriptableObject`.
