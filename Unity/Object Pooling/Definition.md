...
- Theo tài liệu Unity `6.4`, Unity cung cấp sẵn `ObjectPool<T>` trong namespace `UnityEngine.Pool` từ Unity 2021 trở đi, hỗ trợ pool cho cả `GameObject` và các kiểu C# thông thường.
