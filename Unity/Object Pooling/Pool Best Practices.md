...
## Key points
- Unity `6.4`: quản lý state là thách thức lớn nhất khi dùng object pooling, vì object tái sử dụng có thể mang theo state cũ từ lần dùng trước.
...
- State cũ là nguyên nhân phổ biến gây bug khó tìm trong hệ thống pool: projectile bay sai hướng, enemy giữ HP cũ, UI hiển thị data sai.
