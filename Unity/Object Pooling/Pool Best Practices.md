...
## What is it
- Theo tài liệu Unity `6.3`, quản lý state là thách thức lớn nhất khi dùng object pooling, vì object tái sử dụng có thể mang theo state cũ từ lần dùng trước.
...
- Các state cần reset thường gồm: velocity trên `Rigidbody`, animation state, coroutine đang chạy, event subscription, particle system, timer, và `gameObject.SetActive`.
