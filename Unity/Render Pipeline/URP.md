...
## Key points
- Unity `6.3 LTS (6000.3)`: `Universal Render Pipeline` là prebuilt `Scriptable Render Pipeline` của Unity, thiết kế cho workflow artist-friendly và đồ họa tối ưu trên nhiều nền tảng từ mobile tới console và PC.
