...
## Core idea
- `Interface Segregation Principle` yêu cầu client chỉ nên phụ thuộc vào những method mà thực sự cần.
...
- Client chỉ nhận đúng abstraction cần.

## Decision rules
- Tránh class phải implement method rỗng hoặc method không hợp ngữ cảnh.
- Khi interface bắt đầu phình to và phục vụ nhiều loại client khác nhau.
- Khi implementation chỉ dùng được một phần nhỏ của interface hiện tại.
