...
## When to use it
- Dùng khi cùng một tác vụ có nhiều rule hoặc thuật toán thay thế nhau.
- Dùng khi muốn chọn behavior theo config, user type, hoặc runtime state bên ngoài.

## When to not use it
- Không cần nếu chỉ có một thuật toán ổn định và không có dấu hiệu biến thiên.
- Không nên tạo quá nhiều strategy cho bài toán rất nhỏ.
