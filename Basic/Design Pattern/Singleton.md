...
- được dùng cho object mang tính global như config, cache, hoặc service registry đơn giản.
...
- implementation còn thêm lazy initialization để chỉ tạo instance khi cần.
...
- Dùng cho config, service bootstrap đơn giản, hoặc cache dùng chung rõ ràng.
