...
- Nó thường xuất hiện qua `interface`, `abstract class`, hoặc API mô tả “làm gì” hơn là “làm như thế nào”.
...
## When to use it
- Dùng khi có nhiều implementation khác nhau cho cùng một vai trò.
- Dùng khi bạn muốn tách phần business logic khỏi chi tiết hạ tầng hoặc kỹ thuật.

## When to not use it
- Không nên tạo abstraction quá sớm nếu hiện tại chỉ có một implementation rất đơn giản và chưa có áp lực thay đổi.
- Không nên tạo interface chỉ để “cho có”, vì abstraction vô nghĩa sẽ làm code khó lần theo hơn.
