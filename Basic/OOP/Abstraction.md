...
- xuất hiện qua `interface`, `abstract class`, hoặc API mô tả “làm gì” hơn là “làm như thế nào”.
...
- Tránh tạo abstraction quá sớm nếu hiện tại chỉ có một implementation đơn giản và chưa có áp lực thay đổi.
